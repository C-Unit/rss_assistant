...
config :rss_assistant, RssAssistantWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: RssAssistantWeb.ErrorHTML, json: RssAssistantWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: RssAssistant.PubSub,
  live_view: [signing_salt: "ORPgJ0vw"]
...
config :rss_assistant, RssAssistant.Mailer, adapter: Swoosh.Adapters.Local
